      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <Link className="nav-link active" to="/" aria-current="page">{props.homePage}</Link>
             {/* <a className="nav-link active" href="/" aria-current="page">{props.homePage}</a> */}
          </li>
          <li className="nav-item">
        ...
        <div class={`form-check form-switch text-${props.mode==='light'?'dark':'light'}`}>
            ...
            <label className="form-check-label" htmlFor="switch">Toggle Mode</label>
        </div>
      </div>
    </nav>
  );
